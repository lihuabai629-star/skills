---
title: Candidate - 先确认这 `92` 是不是产品/热设计故意限制的。
candidate_id: domain-openubmc-debug-92-e2f24d7199
scope: domain
domain: openubmc-debug
project_root: ''
project_slug: ''
status: active
rule: 先确认这 `92` 是不是产品/热设计故意限制的。
normalized_rule_key: 先确认这 `92` 是不是产品/热设计故意限制的
confidence: 3
...
- session_id: 019d05a2-f350-79e0-a510-9f941db417f6
  ...
  evidence:
  - source: assistant:20
    timestamp: '2026-03-19T10:46:21.408Z'
    excerpt: 先确认这 `92` 是不是产品/热设计故意限制的。
  command_contexts: []
tags:
...
# Candidate - 先确认这 `92` 是不是产品/热设计故意限制的。

## Rule

先确认这 `92` 是不是产品/热设计故意限制的。
...
- assistant:20 @ 2026-03-19T10:46:21.408Z: 先确认这 `92` 是不是产品/热设计故意限制的。
...
| --- | --- | --- | --- |
| 019d05a2-f350-79e0-a510-9f941db417f6 | 3 | assistant:20 | /mnt/e/obsidian-codex-sessions-vault/2026/03/2026-03-19-102738-10-121-177-40100.md |
