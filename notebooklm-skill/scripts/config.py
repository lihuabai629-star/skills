...
QUERY_TIMEOUT_SECONDS = _env_int("NOTEBOOKLM_QUERY_TIMEOUT_SECONDS", 180)
...
QUERY_MAX_TOTAL_SECONDS = _env_int("NOTEBOOKLM_QUERY_MAX_TOTAL_SECONDS", 300)
QUERY_HEARTBEAT_SECONDS = _env_int("NOTEBOOKLM_QUERY_HEARTBEAT_SECONDS", 10)
